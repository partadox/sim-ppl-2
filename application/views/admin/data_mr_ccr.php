            ...
            <table class="tg table-hover" id="dataTable" width="100%" cellspacing="0">
              <thead>
                <tr>
                  ...
                  <th class="tg-s6z2" rowspan="3">Action</th>
                </tr>
                <tr>
              ...
              <tbody>
                ...
                <?php foreach ($laporan_ccr as $ccr) : ?>
                  <tr>
                    ...
                    <td><?= $ccr['name']; ?> </td>
                    <td>
                      <a href="<?= base_url(); ?>admin/hapus_ccr/<?= $ccr['id']; ?>" class="badge badge-danger" onclick="return confirm('Apa anda yakin menghapus data laporan kerusakan ini?');">Hapus</a>
                    </td>
                  </tr>
                  <?php $i++; ?>
                <?php endforeach; ?>
...
<div class="modal fade" id="perawatan-modal" tabindex="-1" role="dialog" aria-labelledby="ModalPetugas" aria-hidden="true">
  <div class="modal-dialog modal-lg" role="document">
    <div class="modal-content">
      ...
      <form action="<?= base_url('admin/tambah_ccr'); ?>" method="post">
