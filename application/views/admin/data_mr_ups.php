              ...
              <tbody>
                ...
                <?php foreach ($laporan_ups as $ups) : ?>
                  <tr>
                    ...
                    <td><?= $ups['name']; ?> </td>
                    <td>
                      <a href="<?= base_url(); ?>admin/hapus_ups/<?= $ups['id']; ?>" class="badge badge-danger" onclick="return confirm('Apa anda yakin menghapus data meter reading ups ini?');">Hapus</a>
                    </td>
                  </tr>
                  <?php $i++; ?>
                <?php endforeach; ?>
...
<div class="modal fade" id="perawatan-modal" tabindex="-1" role="dialog" aria-labelledby="ModalPetugas" aria-hidden="true">
  <div class="modal-dialog modal-lg" role="document">
    <div class="modal-content">
      ...
      <form action="<?= base_url('admin/tambah_ups'); ?>" method="post">
