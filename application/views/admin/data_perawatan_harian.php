...
<div class="col-lg-12">
    <div class="form-group">
          <form action="<?= base_url('admin/tambah_bln_pml'); ?>" method="post">
          <div class="row">
    ...
    <div class="form-group">
      <div> Tata Cara print Laporan Perawatan Harian:</div>
      ...
      <div>2. Mencari data sesuai dengan hari/bulan/tahun data yang ingin di print pada input <b>"search tabel"</b>. Contoh print tanggal 12 Januari 2019 maka ketikan<b>"2019-01-12"</b></div>
      ...
      <div class="card mb-4">
        <div class="card-body">
          <div class="table-responsive" >
            <table id="example" class="tg" style="width:100%" cellspacing="0">
              <thead>
                <tr>
                  <th width="5%">No</th>
