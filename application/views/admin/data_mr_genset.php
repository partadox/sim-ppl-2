              ...
              <tbody>
                ...
                <?php foreach ($laporan_genset as $gnst) : ?>
                  <tr>
                    ...
                    <td><?= $gnst['name']; ?> </td>
                    <td>
                      <a href="<?= base_url(); ?>admin/hapus_genset/<?= $gnst['id']; ?>" class="badge badge-danger" onclick="return confirm('Apa anda yakin menghapus data meter reading genset ini?');">Hapus</a>
                    </td>
                  </tr>
                  <?php $i++; ?>
                <?php endforeach; ?>
...
<div class="modal fade" id="perawatan-modal" tabindex="-1" role="dialog" aria-labelledby="ModalPetugas" aria-hidden="true">
  <div class="modal-dialog modal-lg" role="document">
    <div class="modal-content">
      ...
      <form action="<?= base_url('admin/tambah_genset'); ?>" method="post">
