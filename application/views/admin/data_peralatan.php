                ...
                <?php foreach ($peralatan as $prt) : ?>
                  <tr>
                    ...
                    <td>
                      ...
                      <a href="<?= base_url(); ?>admin/hapus_peralatan/<?= $prt['id']; ?>" class="badge badge-danger" onclick="return confirm('Apa anda yakin menghapus data peralatan ini?');">Hapus</a>
                    </td>
                  </tr>
                  <?php $i++; ?>
                <?php endforeach; ?>
...
<div class="modal fade" id="alat-modal" tabindex="-1" role="dialog" aria-labelledby="ModalPetugas" aria-hidden="true">
  <div class="modal-dialog modal-lg" role="document">
    <div class="modal-content">
      ...
      <form action="<?= base_url('admin/tambah_peralatan'); ?>" method="post">
...
<div class="modal fade" id="alat-modal-edit" tabindex="-1" role="dialog" aria-labelledby="ModalPetugas" aria-hidden="true">
  <div class="modal-dialog modal-lg" role="document">
    <div class="modal-content">
      ...
      <form action="<?= base_url('admin/edit_peralatan'); ?>" method="post">
      <div class="modal-body">
