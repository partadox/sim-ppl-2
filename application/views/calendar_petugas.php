  ...
  <div id="wrapper">
    ...
    <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
      ...
      <a class="sidebar-brand d-flex align-items-center justify-content-center" href="index.html">
        ...
        <div class="sidebar-brand-text">SIM-PPL<sup>Petugas</sup></div>
      </a>
      ...
      <li class="nav-item">
        ...
        <div id="collapsePeralatan" class="collapse" aria-labelledby="headingPeralatan" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            ...
            <a class="collapse-item" href="<?= base_url('petugas/data_peralatan'); ?>">Semua Peralatan</a>
            <a class="collapse-item" href="<?= base_url('petugas/data_peralatan_print'); ?>">Print Data Peralatan</a>
          </div>
        </div>
      </li>
      ...
      <li class="nav-item">
        ...
        <div id="collapseCadang" class="collapse" aria-labelledby="headingCadang" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            <h6 class="collapse-header">Submenu:</h6>
            <a class="collapse-item" href="<?= base_url('petugas/data_skcadang'); ?>">Data Suku Cadang</a>
            <a class="collapse-item" href="<?= base_url('petugas/data_skcadang_print'); ?>">Print Data Sk.Cadang</a>
            <a class="collapse-item" href="<?= base_url('petugas/data_skcadang_keluar'); ?>">Data Sk.Cadang Keluar</a>
            <a class="collapse-item" href="<?= base_url('petugas/data_skcadang_keluar_print'); ?>">Print Sk.Cadang Keluar</a>
          </div>
        </div>
      </li>
      ...
      <li class="nav-item">
        ...
        <div id="collapsePerawatan" class="collapse" aria-labelledby="headingPerawatan" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            <h6 class="collapse-header">Submenu:</h6>
            <a class="collapse-item" href="<?= base_url('petugas/data_perawatan'); ?>">Laporan Pemeliharaan</a>
            <a class="collapse-item" href="<?= base_url('petugas/data_perawatan_harian'); ?>">Pemeliharaan Harian</a>
            <a class="collapse-item" href="<?= base_url('petugas/data_perawatan_mingguan'); ?>">Pemeliharaan Mingguan</a>
            <a class="collapse-item" href="<?= base_url('petugas/data_perawatan_bulanan'); ?>">Pemeliharaan Bulanan</a>
      ...
      <li class="nav-item">
        ...
        <div id="collapseLogbook" class="collapse" aria-labelledby="headingLogbook" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            <h6 class="collapse-header">Submenu:</h6>
            <a class="collapse-item" href="<?= base_url('petugas/data_facility_logbook'); ?>">Data</a>
            <a class="collapse-item" href="<?= base_url('petugas/data_facility_logbook_print'); ?>">Print</a>
          </div>
        </div>
      </li>
      ...
      <li class="nav-item">
        ...
        <div id="collapseLKP" class="collapse" aria-labelledby="headingLKP" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            <h6 class="collapse-header">Submenu:</h6>
            <a class="collapse-item" href="<?= base_url('petugas/data_laporan_kerusakan'); ?>">Data</a>
            <a class="collapse-item" href="<?= base_url('petugas/data_laporan_kerusakan_print'); ?>">Print</a>
          </div>
        </div>
      </li>
      ...
      <li class="nav-item">
        ...
        <div id="collapseMeterReadomg" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            <h6 class="collapse-header">Submenu:</h6>
            <a class="collapse-item" href="<?= base_url('petugas/data_mr_ccr'); ?>">Data CCR</a>
            <a class="collapse-item" href="<?= base_url('petugas/data_mr_ccr_print'); ?>">Print Data CCR</a>
            <a class="collapse-item" href="<?= base_url('petugas/data_mr_ups'); ?>">Data UPS</a>
            <a class="collapse-item" href="<?= base_url('petugas/data_mr_ups_print'); ?>">Print Data UPS</a>
            <a class="collapse-item" href="<?= base_url('petugas/data_mr_genset'); ?>">Data Genset</a>
            <a class="collapse-item" href="<?= base_url('petugas/data_mr_genset_print'); ?>">Print Data Genset</a>
          </div>
        </div>
      </li>
                                      ...
                                      <div class="modal-content">
                                          <form class="form-horizontal" method="POST" action="POST" id="form_create">
                                              ...
                                              <div class="modal-header">
                                                <h5 class="modal-title" id="myModalLabel">Detail Jadwal</h5>
