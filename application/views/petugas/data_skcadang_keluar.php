              ...
              <tbody>
                ...
                <?php foreach ($skcadang_keluar as $prt) : ?>
                  <tr>
                    <th scope="row"><?= $i; ?></th>
                    <td>
                      <a href="<?= base_url(); ?>petugas/hapus_skcadang_keluar/<?= $prt['id']; ?>" class="badge badge-warning" onclick="return confirm('Apa anda yakin suku cadang ini sudah dikembalikan?');">Dikembalikan?</a>
                    </td>
...
<div class="modal fade" id="alat-modal" tabindex="-1" role="dialog" aria-labelledby="ModalPetugas" aria-hidden="true">
  <div class="modal-dialog modal-lg" role="document">
    <div class="modal-content">
      ...
      <form action="<?= base_url('petugas/tambah_skcadang'); ?>" method="post">
...
<div class="modal fade" id="skcadang-modal-edit" tabindex="-1" role="dialog" aria-labelledby="ModalPetugas" aria-hidden="true">
  <div class="modal-dialog modal-lg" role="document">
    <div class="modal-content">
      ...
      <form action="<?= base_url('petugas/edit_skcadang'); ?>" method="post">
      <div class="modal-body">
        <div class="row mt-3">
          <div class="col">
...
<div class="modal fade" id="ambil-modal" tabindex="-1" role="dialog" aria-labelledby="ModalPetugas" aria-hidden="true">
  <div class="modal-dialog modal-lg" role="document">
    <div class="modal-content">
      ...
      <form action="<?= base_url('petugas/ambil_skcadang'); ?>" method="post">
      <div class="modal-body">
        <div class="form-group">
