  ...
  <div id="wrapper">
    ...
    <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
      ...
      <a class="sidebar-brand d-flex align-items-center justify-content-center" href="index.html">
        ...
        <div class="sidebar-brand-text">SIM-PPL<sup style="font-size:9px;">Pemeriksa</sup></div>
      </a>
      ...
      <li class="nav-item">
        ...
        <div id="collapsePerawatan" class="collapse" aria-labelledby="headingPerawatan" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            ...
            <a class="collapse-item" href="<?= base_url('pemeriksa/data_perawatan'); ?>">Laporan Pemeliharaan</a>
            <a class="collapse-item" href="<?= base_url('pemeriksa/data_perawatan_harian'); ?>">Pemeliharaan Harian</a>
            <a class="collapse-item" href="<?= base_url('pemeriksa/data_perawatan_mingguan'); ?>">Pemeliharaan Mingguan</a>
            <a class="collapse-item" href="<?= base_url('pemeriksa/data_perawatan_bulanan'); ?>">Pemeliharaan Bulanan</a>
      ...
      <li class="nav-item">
        ...
        <div id="collapseLogbook" class="collapse" aria-labelledby="headingLogbook" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            <h6 class="collapse-header">Submenu:</h6>
            <a class="collapse-item" href="<?= base_url('pemeriksa/data_facility_logbook'); ?>">Data</a>
            <a class="collapse-item" href="<?= base_url('pemeriksa/data_facility_logbook_print'); ?>">Print</a>
          </div>
        </div>
      </li>
      ...
      <li class="nav-item">
        ...
        <div id="collapseLKP" class="collapse" aria-labelledby="headingLKP" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            <h6 class="collapse-header">Submenu:</h6>
            <a class="collapse-item" href="<?= base_url('pemeriksa/data_laporan_kerusakan'); ?>">Data</a>
            <a class="collapse-item" href="<?= base_url('pemeriksa/data_laporan_kerusakan_print'); ?>">Print</a>
          </div>
        </div>
      </li>
      ...
      <li class="nav-item">
        ...
        <div id="collapseMeterReadomg" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            <h6 class="collapse-header">Submenu:</h6>
            <a class="collapse-item" href="<?= base_url('pemeriksa/data_mr_ccr'); ?>">Data CCR</a>
            <a class="collapse-item" href="<?= base_url('pemeriksa/data_mr_ccr_print'); ?>">Print Data CCR</a>
            <a class="collapse-item" href="<?= base_url('pemeriksa/data_mr_ups'); ?>">Data UPS</a>
            <a class="collapse-item" href="<?= base_url('pemeriksa/data_mr_ups_print'); ?>">Print Data UPS</a>
            <a class="collapse-item" href="<?= base_url('pemeriksa/data_mr_genset'); ?>">Data Genset</a>
            <a class="collapse-item" href="<?= base_url('pemeriksa/data_mr_genset_print'); ?>">Print Data Genset</a>
          </div>
        </div>
      </li>
      ...
      <li class="nav-item">
        <a class="nav-link" href="<?= base_url('pemeriksa/performa_lampu'); ?>">
      ...
      <li class="nav-item">
        <a class="nav-link" href="<?= base_url('pemeriksa/gambar_installasi'); ?>">
          ...
          <ul class="navbar-nav ml-auto">
            ...
            <li class="nav-item dropdown no-arrow">
              <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                <span class="mr-2 d-lg-inline text-gray-600 small">Pemeriksa</span>
